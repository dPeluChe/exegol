...
- Projects can have their own icon and color (right-click → Edit name, icon and color): the app's favicon or icon found in the repo or any of its subrepos, or a built-in icon, shown in the sidebar, the icon rail, the title bar and the project chips
