...
const BUILTIN_PROVIDERS: AgentProvider[] = [
  {
    ...
    capabilities: {
      ...
      supportsResume: true,
      resumeFlag: "--continue",
      resumeCommandPattern: "claude --resume ",
      supportsRPC: false,
      supportsVision: true,
  ...
  },
  {
    ...
    capabilities: {
      ...
      resumeCommandPattern: "codex resume ",
      supportsRPC: false,
  ...
  },
  {
    ...
    capabilities: {
      ...
      promptFlag: "",
      pipelineIdleCloseSeconds: 50,
    },
    isBuiltin: true,
    // Superseded by Antigravity (agy) — kept for historical agent rows, hidden from launcher.
    enabled: false,
  },
  {
    id: "agy",
    ...
    capabilities: {
      ...
      supportsResume: true,
      resumeFlag: "--continue",
      resumeCommandPattern: "agy --conversation ",
      supportsRPC: false,
      supportsVision: true,
      supportsPromptArg: true,
      promptFlag: "-i",
  ...
  },
  {
    ...
    capabilities: {
      ...
      supportsResume: true,
      resumeFlag: "--resume",
      resumeCommandPattern: "droid --resume ",
      supportsRPC: false,
      supportsVision: false,
      supportsPromptArg: true,
      promptFlag: "",
